...
import com.example.android.sunshine.data.DefaultWeather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherData = DefaultWeather.getWeather();

        // DONE (4) Append each String from the fake weather data array to the TextView
        for (String weatherPattern : weatherData) {
            weatherDisplay.append(weatherPattern + "\n\n\n");
        }
    }
}